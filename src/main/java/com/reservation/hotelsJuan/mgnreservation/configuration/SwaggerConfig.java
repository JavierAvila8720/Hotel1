package com.reservation.hotelsJuan.mgnreservation.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.reservation.hotelsJuan.mgnreservation.controller"))
